    ...
    <div id="streamDetail">
        ...
        <div id="main">
            ...
            <div id="listBox">
                ...
                v-model="loading"
                :finished="finished"
                :finished-text="$i18n.streamDetail['没有更多了']"
                @load="onLoad"
                >
...
export default {
    ...
    data() {
        return {
            ...
            // 開始 時間 和 結束 時間 的保存
            time: {
                start: this.$i18n.streamDetail['選擇開始時間'],
                end: this.$i18n.streamDetail['選擇結束時間']
            },
            // 要發送給後端的時間
            postTime: {
                start: '',
    ...
    methods: {
        async getDataByTime (timeQuery) {
            ...
            let res = await $ajax('streamDetail', {
                page: 1,
                start,
                end
            })
